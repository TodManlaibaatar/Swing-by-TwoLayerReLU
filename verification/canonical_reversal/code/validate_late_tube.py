...
parser=argparse.ArgumentParser();parser.add_argument('--reference',type=Path,default=Path('work/crossing-closure/canonical-reference'));parser.add_argument('--output',type=Path,default=Path('outputs/crossing-closure'));parser.add_argument('--radii',type=Path,default=None);parser.add_argument('--workers',type=int,default=4);args=parser.parse_args()
...
if __name__=='__main__':
 r=up(1e-6);history=[];started=time.monotonic()
